...
data_disc, young_data_nondisc = train_test_split(young_data, test_size=0.6, random_state=42)

young_data_train, young_data_sample = train_test_split(young_data_nondisc, test_size=0.1, random_state=42)
old_data_train, old_data_sample = train_test_split(old_data, test_size=0.15, random_state=42)
