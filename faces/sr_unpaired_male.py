...
# only male images in the discriminator
...
data_disc, male_data_nondisc = train_test_split(male_data, test_size=0.5, random_state=42)

female_data_train, female_data_sample = train_test_split(female_data, test_size=0.1, random_state=42)
male_data_train, male_data_sample = train_test_split(male_data_nondisc, test_size=0.1, random_state=42)
