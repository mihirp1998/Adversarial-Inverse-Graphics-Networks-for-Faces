    ...
    def train(self, args):
        ...
        for epoch in range(args.epoch):
            ...
            for idx in range(0, batch_idxs):
                ...
                batch_images_A = [load_train_data(batch_file,args.load_size_B) for batch_file in batch_files_A]
                ...
                _, summary_str_D,dis_loss = self.sess.run(
                    ...
                    feed_dict={self.real_B: batch_images_B,
                               self.fake_B_sample: batch_images_A,
                               self.lr: lr})
